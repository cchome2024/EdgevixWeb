  ...
  const cases = [
    {
      ...
      industry: "製造業",
      title: "智能工廠數碼轉型",
      challenge: "傳統製造流程效率低下，缺乏即時數據監控，難以及時應對市場變化",
      solution: "導入AI視覺檢測系統與IoT設備監控平台，建立即時數據分析儀表板，實現生產流程自動化與智能化管理",
      results: ["生產效率提升40%", "不良品率降低65%", "設備維護成本減少30%", "ROI在8個月內回本"],
    ...
    },
    {
      ...
      industry: "電子商務",
      title: "智能推薦系統開發",
      challenge: "用戶轉換率低，商品推薦不精準，無法有效提升客戶購買意欲",
    ...
    },
    {
      ...
      industry: "醫療健康",
      title: "智能診斷輔助系統",
      challenge: "醫療影像判讀耗時，診斷準確度依賴醫師經驗，需要提升診斷效率與準確度",
      solution: "建立深度學習影像識別模型，開發醫療影像分析平台，提供AI輔助診斷建議與病歷管理系統",
      results: ["診斷時間縮短70%", "準確率達95%以上", "每日處理量增加3倍", "獲得醫療器材認證"],
    ...
    },
    {
      ...
      results: ["學習成效提升60%", "學生完課率提升45%", "教師工作效率提升50%", "用戶續訂率達85%"],
    ...
    },
    {
      ...
      solution: "建立即時風險評估引擎，整合多維度數據源，運用機器學習進行異常檢測與風險預警",
      results: ["欺詐檢測率提升80%", "誤報率降低60%", "審核時間縮短至秒級", "年度損失減少千萬港元"],
          ...
          <div className="max-w-5xl mx-auto space-y-12">
            {cases.map((caseItem, index) => {
              ...
              return (
                <Card
                  key={caseItem.title}
                  className={`${palette.card} border-2 border-slate-700 hover:border-primary/50 hover:shadow-2xl transition-all hover:-translate-y-1`}
                >
                  <CardHeader className="pb-2">
                    <div className="flex items-center gap-4">
                      <div className={`w-12 h-12 ${palette.icon} rounded-xl flex items-center justify-center text-primary shadow-lg`}> 
                        <Icon className="h-6 w-6" />
                      </div>
                      <div>
                        <CardTitle className="text-xl text-white">{caseItem.company}</CardTitle>
                        <Badge className={`${palette.badge} border`}>{caseItem.industry}</Badge>
                      </div>
                    </div>
                  </CardHeader>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <Card className="border-2 border-slate-700 bg-slate-700 hover:shadow-xl transition-all">
                <CardContent className="pt-8">
                  ...
                  <p className="text-slate-300 mb-6 italic leading-relaxed">
                    鋒維科技的專業團隊協助我們成功導入AI系統，不僅提升了生產效率，更為我們開創新的商業模式。他們的技術實力與服務態度都令人印象深刻。
                  </p>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-400">製造企業</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-2 border-slate-700 bg-slate-700 hover:shadow-xl transition-all">
                <CardContent className="pt-8">
                  <div className="text-4xl text-slate-400 mb-4">"</div>
                  <p className="text-slate-300 mb-6 italic leading-relaxed">
                    從需求分析到系統上線，鋒維科技都展現出高度的專業性。他們不只是技術供應商，更是我們的策略伙伴，真正理解我們的業務需要。
                  </p>
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-slate-600 rounded-full flex items-center justify-center">
