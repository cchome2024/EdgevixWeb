...
export default function ServicesPage() {
  const services = [
    ...
    },
    {
      icon: Code2,
      title: "度身訂造軟件開發",
      description: "根據企業需求打造專屬軟件系統，從需求分析到系統投產全程支援。",
      features: ["網頁應用程式開發", "企業管理系統", "電子商務平台", "流動應用開發"],
    },
    {
      icon: Cloud,
      title: "雲端服務整合",
    ...
    },
    {
      icon: Database,
      title: "大數據分析",
      description: "建立數據分析平台，協助企業從數據中發掘商業價值。",
      features: ["數據倉庫建立", "商業智能報表", "即時數據分析", "數據視覺化"],
    },
    {
      icon: Shield,
      title: "資訊安全顧問",
      description: "提供全面的資訊安全評估與防護方案，保護企業數碼資產。",
      features: ["安全性評估", "滲透測試", "資訊安全培訓", "合規顧問"],
    },
    {
      icon: Server,
      title: "系統整合服務",
      description: "整合企業內部各系統，提升資訊流通效率與自動化程度。",
      features: ["API整合開發", "系統對接服務", "自動化流程設計", "舊系統現代化"],
    },
    {
      icon: Smartphone,
      title: "流動應用開發",
      description: "開發iOS與Android原生應用，提供優質的流動體驗。",
      features: ["iOS應用開發", "Android應用開發", "跨平台開發", "程式維護更新"],
    },
    {
      icon: Globe,
      title: "數碼轉型顧問",
      description: "協助企業規劃數碼轉型策略，提供技術路線圖與實施建議。",
      features: ["數碼策略規劃", "技術選擇建議", "流程優化顧問", "變革管理支援"],
    },
  ]
      ...
      <section className="bg-gradient-to-br from-primary to-secondary py-20 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-balance">專業服務範疇</h1>
            <p className="text-xl text-white/90 text-pretty">
              提供全方位技術服務，從AI應用到系統開發，滿足您不同的業務需要。
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center bg-slate-700 p-12 rounded-3xl shadow-xl border border-primary/20">
            ...
            <p className="text-lg text-slate-300 mb-8 text-pretty leading-relaxed">
              我們提供度身訂造的技術方案，歡迎與我們聯絡討論您的需要。
            </p>
            <Button
              size="lg"
              className="bg-gradient-to-r from-accent to-orange-600 hover:from-accent/90 hover:to-orange-600/90 text白 shadow-lg px-8"
              asChild
            >
              <Link href="/contact">
                立即查詢 <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
            </Button>
          </div>
        </div>
